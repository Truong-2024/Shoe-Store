        ...
        <div id="header">
            <nav class="container">
                ...
                <div class="search-container">
                    ...
                    <button type="button" id="search-button"class="search-icon"><i class="fas fa-search"></i></button>
                </div>
            ...
            <ul class="products">
                ...
                <li>
                    <div class="product-item">
                        ...
                        <div class="product-infor">
                            <a href="" class="product-cat">nike</a>
                            <a href="" class="product-name">Giày Nike Nam Nữ Chính Hãng Air Force 1 LV8</a>
            ...
            <ul class="products">
                ...
                <li>
                    <div class="product-item">
                        ...
                        <div class="product-infor">
                            <a href="" class="product-cat">giày tây</a>
                            <a href="" class="product-name">giày tây đông hải</a>
                            <div class="product-price">510.000đ</div>
                        </div>
                    </div>
                </li>
    ...
    function performSearch() {
        ...
        for (var i = 0; i < productNames.length; i++) {
            ...
            if (productName.includes(searchQuery)) {
                ...
                productNames[i].closest('.product-item').style.display = "block";
            } else {
                // Hide the product if it does not match the search query
                productNames[i].closest('.product-item').style.display = "none";
            }
        }
    }
